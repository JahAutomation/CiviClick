	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		File _congressMainPage = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
							try {
								...
								System.out.println("=====================================================");	
								Thread.sleep(3000);					
								FileUtils.copyFile(_congressMainPage, new File("C:\\CiviTestScreenshot\\CongressHouse_MainPage.png"));   	           
								Thread.sleep(2000);												
							} catch (IOException e) {
				...
				Thread.sleep(2000);
							...
							File screenshotMid = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
										try {
											...
											System.out.println("=====================================================");	
											Thread.sleep(7000);					
											FileUtils.copyFile(screenshotMid, new File("C:\\CiviTestScreenshot\\CongressHouse_SelectedTargets.png"));   	           
											Thread.sleep(2000);												
										} catch (IOException e) {
											System.out.println(e.getMessage());
										}
							...
							File _addedTargets = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
										try {
											...
											System.out.println("=====================================================");	
											Thread.sleep(8000);					
											FileUtils.copyFile(_addedTargets, new File("C:\\CiviTestScreenshot\\CongressHouse_AddedTargets.png"));   	           
											Thread.sleep(2000);												
										} catch (IOException e) {
											System.out.println(e.getMessage());
										}	
							...
							Thread.sleep(11000);
										...
										try {
											...
											System.out.println("=====================================================");	
											Thread.sleep(7500);					
											FileUtils.copyFile(_removeAllTargets, new File("C:\\CiviTestScreenshot\\CongressHouse_RemoveAllTargets.png"));   	           
											Thread.sleep(2000);												
										} catch (IOException e) {
											System.out.println(e.getMessage());
										}	
