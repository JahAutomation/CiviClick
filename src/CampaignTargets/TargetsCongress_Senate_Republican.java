...
public class TargetsCongress_Senate_Republican {
	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		File _congressMainPage = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
							try {
								//System.out.println("=====================================================");
								System.out.println("Taking Screenshot - Targets Congress Senate + Republican Page..");
								System.out.println("===============================================================");	
								Thread.sleep(4000);					
								FileUtils.copyFile(_congressMainPage, new File("C:\\CiviTestScreenshot\\CongressSenateRepublican_MainPage.png"));   	           
								Thread.sleep(2000);												
							} catch (IOException e) {
				...
				Thread.sleep(2000);
							...
							File screenshotMid = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
										try {
											...
											System.out.println("=====================================================");	
											Thread.sleep(4000);					
											FileUtils.copyFile(screenshotMid, new File("C:\\CiviTestScreenshot\\CongressSenateRepublican_SelectedTargets.png"));   	           
											Thread.sleep(2000);												
										} catch (IOException e) {
											System.out.println(e.getMessage());
										}
							...
							File _addedTargets = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
										try {
											...
											System.out.println("=====================================================");	
											Thread.sleep(1000);					
											FileUtils.copyFile(_addedTargets, new File("C:\\CiviTestScreenshot\\CongressSenateRepublican_AddedTargets.png"));   	           
											Thread.sleep(2000);												
										} catch (IOException e) {
											System.out.println(e.getMessage());
										}	
							...
							File _removeAllTargets = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
										try {
											...
											System.out.println("=====================================================");	
											Thread.sleep(8000);					
											FileUtils.copyFile(_removeAllTargets, new File("C:\\CiviTestScreenshot\\CongressSenateRepublican_RemoveAllTargets.png"));   	           
											Thread.sleep(2000);												
										} catch (IOException e) {
											System.out.println(e.getMessage());
										}	
