...
public class TargetsCongress_Senate_Democrat_State {
	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		Thread.sleep(5000);
		//System.out.println("=====================================================");
		System.out.println("Clicking Congress Senate..");
		System.out.println("=====================================================");
		WebElement _clickSenate = driver.findElement
		(By.cssSelector(_campaign._senateCheckBox));
		_clickSenate.click();
		Thread.sleep(3000);

		//System.out.println("=====================================================");
		System.out.println("Clicking Congress Democrat..");
		System.out.println("============================================================");
		WebElement _clickDemocrat = driver.findElement
		(By.cssSelector(_campaign._democrat));
		_clickDemocrat.click();
		Thread.sleep(3000);
		...
		File _congressMainPage = ((TakesScreenshot) driver).getScreenshotAs(OutputType.FILE);
							try {
								//System.out.println("=====================================================");
								System.out.println("Taking Screenshot - Targets Congress Senate + Democrat + State Page..");
								System.out.println("====================================================================");	
								Thread.sleep(4000);					
								FileUtils.copyFile(_congressMainPage, new File("C:\\CiviTestScreenshot\\CongressSenateDemocrat_State_MainPage.png"));   	           
								Thread.sleep(2000);												
							} catch (IOException e) {
				...
				// 							System.out.println("=====================================================");	
				// 							Thread.sleep(4000);					
				// 							FileUtils.copyFile(screenshotMid, new File("C:\\CiviTestScreenshot\\CongressSenateDemocrat_State_SelectedTargets.png"));   	           
				// 							Thread.sleep(2000);												
				// 						} catch (IOException e) {
				// 							System.out.println(e.getMessage());
				// 						}
				...
				// 							System.out.println("=====================================================");	
				// 							Thread.sleep(1000);					
				// 							FileUtils.copyFile(_addedTargets, new File("C:\\CiviTestScreenshot\\CongressSenateDemocrat_State_AddedTargets.png"));   	           
				// 							Thread.sleep(2000);												
				// 						} catch (IOException e) {
				// 							System.out.println(e.getMessage());
				// 						}	
				...
				// 							System.out.println("=====================================================");	
				// 							Thread.sleep(7500);					
				// 							FileUtils.copyFile(_removeAllTargets, new File("C:\\CiviTestScreenshot\\CongressSenateDemocrat_State_RemoveAllTargets.png"));   	           
				// 							Thread.sleep(2000);												
				// 						} catch (IOException e) {
				// 							System.out.println(e.getMessage());
				// 						}	
