...
public class Display_ImageTop_Style {
	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		_gotoDisplayTab.click();
						...
						System.out.println("=====================================================");
						Thread.sleep(500);
						WebElement _clickImageTopStyle = driver.findElement
						(By.cssSelector(_elements._clickImageTopStyle));
						Thread.sleep(50);
						_clickImageTopStyle.click();
						Thread.sleep(600);
										...
										if(!handles.equals(parentID)) {	
											Thread.sleep(5000);	
												...
												try {
										            ...
										            FileUtils.copyFile(screenshotMid, new File("C:\\CiviTestScreenshot\\Display_ImageTopStyle.png"));   	           
										            Thread.sleep(2000);
