...
public class Display_ShowNumberOfActionsTaken {
	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		_gotoDisplayTab.click();
						...
						jah.executeScript("window.scrollBy(0,700)", "");
						
								WebElement _clickShowNumberActionsTakenButton = driver.findElement
								(By.cssSelector(_elements._showNumberActionsTaken));
								Thread.sleep(50);
								_clickShowNumberActionsTakenButton.click();
								Thread.sleep(1000);
								...
								WebElement _clickSaveButton = driver.findElement
										...
										jah4.executeScript("window.scrollBy(0,-800)", "");
										Thread.sleep(500);	
												...
												if(!handles.equals(parentID)) {	
													...
													Thread.sleep(7000);	
													try {
															String _checkingActionDetails = driver.findElement
															(By.xpath(_elements._checkingActionDetails)).getText();
															//System.out.println("=====================================================");
															System.out.println("Loading Actions Taken..");
															System.out.println("=====================================================");
															//System.out.println("=====================================================");
															System.out.println(_checkingActionDetails);
															System.out.println("=====================================================");
															Thread.sleep(13000);	
													}catch(NoSuchElementException e) {
														//System.out.println("=====================================================");
														System.out.println("ShowNumberOfActionsTaken Button is disabled..");
														System.out.println("=====================================================");
												...
												try {
										            ...
										            FileUtils.copyFile(screenshotMid, new File("C:\\CiviTestScreenshot\\Display_NumberOfActionsTaken.png"));   	           
										            Thread.sleep(2000);
