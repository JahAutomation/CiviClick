...
public class Display_ImageHeader_Style {
	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		_gotoDisplayTab.click();
						...
						System.out.println("=====================================================");
						Thread.sleep(500);
						WebElement _clickImageHeaderStyle = driver.findElement
						(By.cssSelector(_elements._clickImageHeaderStyle));
						Thread.sleep(50);
						_clickImageHeaderStyle.click();
						Thread.sleep(600);
										...
										if(!handles.equals(parentID)) {	
											Thread.sleep(5000);	
												...
												try {
										            ...
										            FileUtils.copyFile(screenshotMid, new File("C:\\CiviTestScreenshot\\Display_ImageHeaderStyle.png"));   	           
										            Thread.sleep(2000);
