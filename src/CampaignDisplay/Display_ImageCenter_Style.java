...
public class Display_ImageCenter_Style {
	...
	public static void main(String args[]) throws InterruptedException, AWTException {
		...
		_gotoDisplayTab.click();
						...
						System.out.println("=====================================================");
						Thread.sleep(500);
						WebElement _clickImageCenterStyle = driver.findElement
						(By.cssSelector(_elements._clickImageCenterStyle));
						Thread.sleep(50);
						_clickImageCenterStyle.click();
						Thread.sleep(600);
										...
										if(!handles.equals(parentID)) {	
											Thread.sleep(5000);	
												...
												try {
										            ...
										            FileUtils.copyFile(screenshotMid, new File("C:\\CiviTestScreenshot\\Display_ImageCenterStyle.png"));   	           
										            Thread.sleep(2000);
